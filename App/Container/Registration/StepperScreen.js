    ...
    return (
        <View style={{marginBottom:10}}>
            <View style={{flexDirection:'row'}}>
                ...
                <Text style={[props.step===3? {fontWeight:'bold', backgroundColor:'#AFAFAF'}: {backgroundColor:'#DFDFDF'}, {width:'25%', textAlign:'center', fontSize:12,  padding:3}]}>4. Persyaratan</Text>
            </View>                    
        </View> 
    )
}
